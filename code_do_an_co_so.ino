...
int cam_bien_vat_can()
{
  ...
  // Serial.print("in: ");
  // Serial.println(doc_vat_can_in);
  // Serial.print("out: ");
  // Serial.println(doc_vat_can_out);
...
void den_ham_xe()
{
  ...
  if(doc_chuyen_dong == 1)
  {
    ...
    // Serial.println(doc_chuyen_dong );
}
...
void loop() {
  ...
  // Serial.print("Tin hieu barie: ");
  // Serial.println(dieu_khien_barie);
  // delay(1000);
